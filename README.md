# @kemus's fork
I've never worked with TypeScript before, so don't expect any ongoing support.
:P

Merges several pull requests with the obsidian-calendar-plugin that was last
updated 3+ years ago.

Original code is MIT License, I assume since none of the new PRs changed the
`LICENSE` file that that was their intention as well. Regardless, if anyone
would like me to remove their code from this fork, please message me and I will
do so.

[#186](https://github.com/liamcain/obsidian-calendar-plugin/pull/186) - Accept
in-note tags, by @Heniker

[#275](https://github.com/liamcain/obsidian-calendar-plugin/pull/275) - Adds
hotkey to show the calendar tab view, by @romansemko

[#297](https://github.com/liamcain/obsidian-calendar-plugin/pull/297) - Fix word
count for non-space-delimited characters, by @jasonszang

[#323](https://github.com/liamcain/obsidian-calendar-plugin/pull/323) - Add view
mode override for new calendar notes, by @Mansarde

[#331](https://github.com/liamcain/obsidian-calendar-plugin/pull/331) - Add
Options for Opening In New Tab, by @WilliamsJack

[#374](https://github.com/liamcain/obsidian-calendar-plugin/pull/374) - Change
icon to calendar-days, by @infogulch
